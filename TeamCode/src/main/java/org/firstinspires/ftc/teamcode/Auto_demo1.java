...
@Autonomous(name="Auto Demo 1", group="Robot")
...
public class Auto_demo1 extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        drive("forward", 15, DRIVE_SPEED, 5.0);
        drive("right", 15, DRIVE_SPEED, 5.0);
        drive("backward", 15, DRIVE_SPEED, 5.0);
        drive("left", 15, DRIVE_SPEED, 5.0);
